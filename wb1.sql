...
select movie_name,artist_name,role from Movies 
Inner join artist_role_movie  on   movies.Id=artist_role_movie.movie_Id
Inner join artist on artist.Id=artist_role_movie.artist_Id ;
